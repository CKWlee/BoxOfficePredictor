...
def evaluate_model(model, X_test, y_test, model_name: str) -> dict:
    ...
    # convert back from log scale so dollar errors are human readable
...
def hyperparameter_tuning(X_train, y_train) -> XGBRegressor:
    # grid search on xgboost — slow, skip unless you want to tune
...
def main():
    ...
    # uncomment to run grid search (takes a while)
