...
def get_unique_values(df):
    # top directors/actors/companies for the dropdowns
...
def build_feature_vector(inputs, df, feature_columns):
    ...
    # competition — use dataset averages since we can't know the future release calendar
    ...
    # keyword signals derived from genre/franchise
...
def main():
    ...
    with col2:
        try:
            ...
            prediction = max(prediction, 1_000_000)
